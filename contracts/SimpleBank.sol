...
contract SimpleBank {
    ...
    function enroll() public returns (bool) {
        require(enrolled[msg.sender] != true, "Customer already enrolled");
    ...
    function deposit() public payable returns (uint256) {
        ...
        require(enrolled[msg.sender], "Sender address is not a customer");
    ...
    function withdraw(uint256 withdrawAmount) public returns (uint256) {
        ...
        require(
            ...
            "Withdraw amount exceeds total balance. Account overdraft not implemented."
        );
